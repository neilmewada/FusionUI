...
namespace Fusion
{
    ...
    public:
		...
		virtual FAtlasHandle CreateLayeredAtlas(bool grayscale, u32 resolution, u32 numLayers) = 0;
		...
		virtual void SetImageAtlas(FInstanceHandle instance, FAtlasHandle atlas) = 0;
